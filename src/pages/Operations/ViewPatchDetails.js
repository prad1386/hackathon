...
import { viewPatch } from "@store/patchesOperation.duck";
...
const ViewPatchDetails = () => {
  const {
    viewPatchDetails: data,
    activityLog,
    loading,
  } = useSelector((state) => state.patchesOperation);
  const dispatch = useDispatch();

  const { campaign_id, asset_instance_id } = useParams();

  useEffect(() => {
    dispatch(viewPatch({ campaign_id, asset_instance_id }));
  }, [dispatch, campaign_id, asset_instance_id]);
      ...
      <section className="content-layout">
        <div className="sub-heading mb-2">
          <div className="d-flex">
            ...
            <div className="p-2">
              <Link className="btn btn-primary px-4 btn-sm" to="/operations">
            ...
            <>
              <Col sm={6} className="mt-2 bd-highlight">
                ...
                <div className="d-flex">
                  ...
                  <div className="p-2 flex-fill">
                    {data.manual_campaign === true ? "yes" : "no"}
                  </div>
                </div>
                <div className="d-flex">
                  <div className="p-2 camp-label uppercase">
              ...
              <Col sm={6} className="mt-2 bd-highlight">
                <div className="d-flex">
                  ...
                  <div className="p-2 flex-fill">{data.patch_status}</div>
                </div>
                <div className="d-flex">
                  <div className="p-2 camp-label uppercase">
                    {constants.TEXT_PRECHECK_STATUS}
                  </div>
                  <div className="p-2 flex-fill">{data.patch_precheck}</div>
                </div>
                <div className="d-flex">
                  <div className="p-2 camp-label uppercase">
                    {constants.TEXT_POSTCHECK_STATUS}
                  </div>
                  <div className="p-2 flex-fill">{data.patch_postcheck}</div>
                </div>
                <div className="d-flex">
                  <div className="p-2 camp-label uppercase">
                ...
                <div className="d-flex">
                  ...
                  <div className="p-2 flex-fill">{data.scheduled_date}</div>
                </div>
                <div className="d-flex">
                  <div className="p-2 camp-label uppercase">
                ...
                <div className="d-flex">
                  <div className="p-2 camp-label uppercase">
                    {constants.TEXT_OPERATOR_NAME}
                  </div>
                  <div className="p-2 flex-fill">{data.operator_name}</div>
                </div>
                <div className="d-flex">
                  <div className="p-2 camp-label uppercase">
                    {constants.TEXT_OPERATOR_NOTES}
                  </div>
                  <div className="p-2 flex-fill">{data.operator_notes}</div>
                </div>
              </Col>
              <hr className="mt-3" />
              <div>
...
export default ViewPatchDetails;
